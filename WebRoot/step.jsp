			...
			<div class="rightcontent" id="rightcontent">
				...
				<div class="tab">
					...
					<form id="step3form">
						<div class="formcontent">
							<div class="form-item textarea">
								<span>Career situation:</span><textarea id="work.workInfoApplication.workInfo"  name="work.workInfoApplication.workInfo" rows="6" cols="60" ><s:property value="baseApplication.workInfoApplication.workInfo"/></textarea>
							</div>
						</div>
						...
						<div class="formbutton">
							<input type="button" class="btn back" value="back"  onclick="move('select', {top:100});tab3(this)"/>
							<input type="button" class="btn" value="next" onclick="move('select', {top:300});tab2(this)"/>
